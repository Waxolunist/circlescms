var cc = require('../server/rpc/cc.js')('resource', 'resource.provider', 'resource.provider.git', 'resource.provider.fs', 'parser', 'parser.markdown'),
...
exports.testResourceProviderRegistration = function(test) {
  ...
  test.deepEqual(cc.resource.provider.Registry.getProviderByName("git"), gitprovider);
  ...
  cc.resource.provider.Registry.registerProvider(fsprovider.getName(), fsprovider);
  test.deepEqual(cc.resource.provider.Registry.getProviderByName("fs"), fsprovider);
