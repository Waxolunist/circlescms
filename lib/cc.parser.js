...
define(function(require) {
  ...
  parser.DefaultParser = dejavu.Class.declare({
    ...
    /**
     * Returns the data as it is unprocessed as object:
     *
     *     {
     *       content: <content to render>
     *     }
     *
     * @method parseContent
     * @for parser.DefaultParser
     * @param {String} data the data to be returned
     * @return {Object} An object containing the data given as property 'content'.
     */
    parseContent: function(data, nocontent) {
      return {
        content: data 
